...
const d = decodeProjectFile(encodeProjectFile({ terrain, heightmap, cliffGrassDensity, cliffPaint, grass, snowParams }));
...
check("an older file has none of them", old.cliffGrassDensity === null && old.cliffPaint === null && old.grass === null && old.snowParams === null);
