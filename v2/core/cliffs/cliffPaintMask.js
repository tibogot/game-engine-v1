...
/**
 * World-fixed cliff-blend paint mask (v1 cliffPaintTex parity).
 * R channel = override strength (0..255 → 0..1); painted areas force terrain ground colour on cliffs.
 */
export class CliffPaintMask {
  constructor(res = 512) {
    this.res = res;
