...
import { createClipmapGroundY } from "../../core/terrain/clipmapGroundY.js";
...
export class HybridGrassSystem {
  ...
  /**
   * Height of the terrain MESH at world XZ, so a blade stands on the triangle
   * the clipmap actually draws rather than on the heightmap under it. The math
   * is shared with the revo grass tile: v2/core/terrain/clipmapGroundY.js.
   */
  _clipmapGroundY(worldX, worldZ, heightTex, uTerrainSize) {
    this._clipGroundY ??= createClipmapGroundY(this._terrainSurface);
    return this._clipGroundY(worldX, worldZ, heightTex, uTerrainSize);
  }
