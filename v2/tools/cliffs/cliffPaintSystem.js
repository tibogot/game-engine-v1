...
/** Brush paint for the cliff-blend override mask (world XZ, terrain hit). */
export class CliffPaintSystem {
  ...
  applyAt(hitPoint, event = {}) {
    ...
    const erase = event.altKey || this.toolState.cliffPaint?.erase;
    this.mask.stamp({
      cx: hitPoint.x,
      cz: hitPoint.z,
      radius: brush.radius,
