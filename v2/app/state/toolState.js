...
export function createToolState() {
  return {
    ...
    // Smart Road 2 (lab system) — only the params SmartRoadLabSystem reads.
    // Mirrors SMART_ROAD_DEFAULTS in tools/smartRoad/smartRoadLabSystem.js.
    smartRoad2: {
      width: 14,
      lanesPerDir: 1,
      junctionRadius: 14,
    ...
    snow2: {
      ...
      grooveScale:     1.0,
      rimRidgeScale:   0.14,
      rimSampleOffset: 0.55,
      normalNeighbourShift: 0.35,
      trailWorldSize:  50,
      trailStampStep:  0.10,
      trailRegrowPerFrame: 0,
      trailAlbedoCavity:   0.55,
      trailRoughnessBoost: 0.28,
      wheelRadius:     0.42,
      wheelDepth:      0.5,
      wheelPushScale:  0.6,
      chassisStampEnabled: false,
